...
export default function EditRoomPage() {
  ...
  async function loadRoom(roomId: string) {
    ...
    setFormState({
      ...
      total_rooms: (room as any).total_rooms?.toString() || '',
      vacancy_count: (room as any).vacancy_count?.toString() || '',
      has_window: (room as any).has_window ?? true,
      private_bathroom: (room as any).private_bathroom || false,
      private_kitchen: (room as any).private_kitchen || false,
      direction: (room as any).direction || '',
      elevator: (room as any).elevator || false,
      building_year: (room as any).building_year?.toString() || '',
      utilities_included: (room as any).utilities_included || false,
      female_safe: (room as any).female_safe || false,
      smoking_allowed: (room as any).smoking_allowed || false,
      has_cafeteria: (room as any).has_cafeteria || false,
      no_curfew: (room as any).no_curfew ?? true,
